...
(define_insn "movdf"
  [(set (match_operand:DF 0 "general_operand" "=rm,&rf,&rof<>,y,rm,x,!xrm")
	(match_operand:DF 1 "general_operand" "rf,m,rofF<>,rmF,y,xH,xrm"))]
...
(define_insn "movdi"
  [(set (match_operand:DI 0 "general_operand" "=rm,&rf,&ro<>,!&rm,!&f,y,rm,x,!xrm")
	(match_operand:DI 1 "general_operand" "r,m,roi<>,fF,rfF,rmi,y,x,xrm"))]
